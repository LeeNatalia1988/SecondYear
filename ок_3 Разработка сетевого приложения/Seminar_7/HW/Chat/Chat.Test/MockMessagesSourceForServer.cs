...
namespace Chat.Test
{
    public class MockMessagesSourceForServer : IMessageSource
    {
        ...
        private IPEndPoint _udpServerEndPoint = new IPEndPoint(IPAddress.Parse("127.0.0.1"), 12345);
        ...
        public MockMessagesSourceForServer()
        {
